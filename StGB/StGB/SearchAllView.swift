...
//  STGB
//
//  Created by Peter Oertig on 03.08.20.
...
struct SearchAllView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            List {
                Group {
                    Section(header: Text("Allgemeiner Teil (Art. 1-110)")
                                .foregroundColor(Color(UIColor.systemBlue))
                            
                    ) { //STGBAT VStack
                        
                        ForEach(gesetzestextSTGBAT.filter {
                            self.searchTerm.isEmpty ? false : $0.buch.localizedCaseInsensitiveContains(searchTerm)
                        ...
                        }// Closing STGBAT VStack
                        .id(UUID())
                    }
                    
                    Section(header: Text("Besonderer Teil (Art. 111-392)")
        ...
        .navigationBarTitle(Text("Suche über Alles").font(.callout), displayMode: .inline)
...
struct SearchAllView_Previews: PreviewProvider {
    static var previews: some View {
        SearchAllView(gesetzestextSTGBAT: dataSTGBAT, gesetzestextSTGBBT: dataSTGBBT, gesetzestextSTGBBT2: dataSTGBBT2, gesetzestextSTGBBT3: dataSTGBBT3 )
    }
}
